...
if($data_fare['response_code']==200){
    echo '
				...
				<h3>Showing Fare Of Train <span class="label label-warning">'.$data_fare['train']['name'].'</span><span class="badge">('.$data_fare['train']['number'].')</span> From <span class="label label-warning">'.$data_fare['from']['name'].'</span><span class="badge">('.$data_fare['from']['code'].')</span> To <span class="label label-warning">'.$data_fare['to']['name'].'</span><span class="badge">('.$data_fare['to']['code'].')</span></h3>
				</section>
				</div>
