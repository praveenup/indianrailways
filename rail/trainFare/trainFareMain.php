...
<div class="alert alert-info" style="margin-top: 50px;">
    <div class="container-fluid">
        <h1 class="text-center" style="margin-top: 0;">Check Train Fare</h1>
        <form class="form-horizontal"  action="trainFareMain.php" method="POST">
                ...
                <div class="col-sm-12">
                    ...
                    if($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if(empty($_POST["txtTrainNo"])){
                            echo "<div class='alert alert-danger text-center'>Please Enter Train Number In Specified Field</div>";
                        ...
                        }elseif (empty($_POST["selAge"])){
                            echo "<div class='alert alert-danger text-center'>Please Select Age From Specified Field</div>";
                        }elseif (empty($_POST["selQuota"])){
                            echo "<div class='alert alert-danger text-center'>Please Select Quota From Specified Field</div>";
                        }elseif (empty($_POST["txtTrainDate"])){
                            echo "<div class='alert alert-danger text-center'>Please Select Date From Specified Field</div>";
                        }
                    }
                    ?>
...
<?php
if(!empty($_POST['txtSrcCode']) && !empty($_POST['txtDestCode']) && !empty($_POST['txtTrainNo']) && !empty($_POST['txtTrainDate'])){
